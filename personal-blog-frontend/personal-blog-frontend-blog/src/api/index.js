...
export const reqAddBlog = ({ title, category_id, content, tags_id }) =>
    ajax('/manage/blog/add', { title, category_id, content, tags_id }, 'POST');
...
export const reqEditBlog = ({
    ...
    ajax(
        '/manage/blog/edit',
        { blog_id, title, category_id, tags_id, content },
        'POST',
    );
...
export const reqBlogById = (blog_id) =>
    ajax('/public/blog/blogById', { blog_id });

export const reqBlogListByIds = (blogs_id) =>
    ajax('/public/blog/blogListByIds', { blogs_id });

export const reqTagsByIds = (tags_id) =>
    ajax('/public/tag/tagsByIds', { tags_id });

export const reqTagByTagName = (name) =>
    ajax('/public/tag/tagByTagName', { name });
